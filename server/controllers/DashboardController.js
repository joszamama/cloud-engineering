...
setInterval(async () => {
    ...
    new Dashboard({
        ...
        trip_deviation: managedTrips[0].std,
    ...
    }).save().catch(err => console.log(`Could not compute dashboard: ${err}`));
}, 1800000);